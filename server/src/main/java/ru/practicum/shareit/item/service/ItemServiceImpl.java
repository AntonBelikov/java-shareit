...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto create(Long userId, ItemDto itemDto) {
        ...
        if (requestId != null) {
            ItemRequest request = itemRequestRepository.findById(requestId)
                    .orElseThrow(() -> new NotFoundObject("Запрос вещи не найден: " + requestId));
    ...
    private void setLastNextFromMaps(ItemDto dto, Map<Long, Booking> lastByItemId,
                                     Map<Long, Booking> nextByItemId) {
        Long itemId = dto.getId();
